<<<<<<<< HEAD:app/src/main/java/com/umc/chamma/ui/home/ReviewActivity.kt
package com.android.chamma.ui.home
========
package com.umc.chamma.ui.toiletlist
>>>>>>>> dev:app/src/main/java/com/umc/chamma/ui/toiletlist/ReviewActivity.kt
...
class ReviewActivity : com.umc.chamma.config.BaseActivityVB<ActivityReviewBinding>(ActivityReviewBinding::inflate) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val dataList:ArrayList<com.umc.chamma.models.toiletlistmodel.ReviewData> = arrayListOf()
...
<<<<<<<< HEAD:app/src/main/java/com/umc/chamma/ui/home/ReviewActivity.kt
            ...
            add(
                ...
                "화장실 너무 깨끗해요\n휴지도 넉넉하게 있어서 좋았어요!")
========
                com.umc.chamma.models.toiletlistmodel.ReviewData(
                    "나는참지않쥐", R.drawable.review_profile, "23.", "07.", 11, 5f,
                    "화장실 너무 깨끗해요\n휴지도 넉넉하게 있어서 좋았어요!"
                )
            )
            add(
                com.umc.chamma.models.toiletlistmodel.ReviewData(
                    "읏차", R.drawable.review_profile2, "23.", "06.", 30, 5f,
                    "관리가 잘 되어 있어요~"
                )
            )
            add(
                com.umc.chamma.models.toiletlistmodel.ReviewData(
                    "minjji7", R.drawable.review_profile3, "23.", "06.", 30, 4f,
                    "냄새 탈취제 있으면 더 좋을거 같음"
                )
            )
            add(
                com.umc.chamma.models.toiletlistmodel.ReviewData(
                    "dkwe32", R.drawable.review_profile4, "23.", "06.", 28, 5f,
                    "깔끔해요 화장실 급할 때 이 근처면 여기만 갈 것 같아요"
                )
            )
            add(
                com.umc.chamma.models.toiletlistmodel.ReviewData(
                    "급해", R.drawable.review_profile5, "23.", "06.", 21, 5f,
                    "화장실 너무 깨끗해요\n휴지도 넉넉하게 있어서 좋았어요!"
                )
>>>>>>>> dev:app/src/main/java/com/umc/chamma/ui/toiletlist/ReviewActivity.kt
            )
